...
func _ready():
	...
	var cards = load("res://Scenes/UI/Town/TownEventScreens/Trainer/cards.tscn")
	var skills = load("res://Scenes/UI/Town/TownEventScreens/Trainer/skills.tscn")
	var talents = load("res://Scenes/UI/Town/TownEventScreens/Trainer/talents.tscn")
	
	selection_array = [cards, skills, talents]
	create_encounter()
