...
func finish_drag_consumable():
	$"../AHConsumableDisplay".animate_consumable_to_position(consumable_being_dragged, consumable_previous_position)
...
func buy_consumable():
	...
	get_tree().get_first_node_in_group("character").add_consumable(consumable_being_dragged.consumable_stats)
	$"../AHConsumableDisplay".remove_consumable_from_inventory(consumable_being_dragged)
