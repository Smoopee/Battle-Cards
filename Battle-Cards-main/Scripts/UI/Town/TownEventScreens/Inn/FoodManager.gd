...
func finish_drag_consumable():
	$"../CreateFood".animate_consumable_to_position(consumable_being_dragged, consumable_previous_position)
...
func buy_consumable():
	...
	$"../CreateFood".remove_consumable_from_inventory(consumable_being_dragged)
