...
func _ready():
	...
	var rest = load("res://Scenes/UI/Camp/rest.tscn")
	var eat = load("res://Scenes/UI/Camp/eat.tscn")
	var hunt = load("res://Scenes/UI/Camp/hunt.tscn")
	
	selection_array = [rest, eat, hunt]
	create_encounter()
