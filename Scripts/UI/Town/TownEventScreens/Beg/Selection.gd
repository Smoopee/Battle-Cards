...
func _ready():
	...
	var beg = load("res://Scenes/UI/Town/TownEventScreens/Beg/Beg.tscn")
	var steal = load("res://Scenes/UI/Town/TownEventScreens/Beg/Steal.tscn")
	var intimidate = load("res://Scenes/UI/Town/TownEventScreens/Beg/Intimidate.tscn")
	
	selection_array = [beg, steal, intimidate]
	create_encounter()
