...
func effect():
	...
	get_tree().get_first_node_in_group("card manager").ah_mode = "Consumables"
	...
	var potion = load("res://Scenes/UI/Town/TownEventScreens/AH/Tags/Potion.tscn")
	
	selection_array = [cd, common, potion]
