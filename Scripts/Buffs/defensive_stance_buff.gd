...
var count = 0
var buff_name = "Defensive Stance"
var attached_to
var buff_effect1
var buff_effect2
var buff_effect3
...
func _ready():
	...
	update_tooltip("Effect", "+" + str(buff_effect1) + " Def",  "Effect: ")

func buff_initializer(source,target):
	buff_effect1 = source.card_stats.effect2
	attached_to = target
...
func buff_counter(amount = null):
	...
	update_tooltip("Effect", "+" + str(buff_effect1) + " Def")
